...
export async function listarEnfermerasConfirmacionRecursos() {
  return apiCall<{ success: boolean; profesionales: any[]; total: number }>("GET", "/despachos-recursos/enfermeras-confirmacion");
}
