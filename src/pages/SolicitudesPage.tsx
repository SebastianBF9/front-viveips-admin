...
export function SolicitudesPage({ gestion = false }: { gestion?: boolean }) {
  ...
  const estadoGestionRef = useRef<HTMLSelectElement>(null);
  const prioridadGestionRef = useRef<HTMLSelectElement>(null);
  const responsableGestionRef = useRef<HTMLInputElement>(null);
  ...
  async function guardarGestion() {
    ...
    try {
      const payload = {
        estado: estadoGestionRef.current?.value || gestionForm.estado,
        prioridad: prioridadGestionRef.current?.value || gestionForm.prioridad,
        responsable: responsableGestionRef.current?.value || "",
      };
