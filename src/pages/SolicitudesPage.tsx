...
export function SolicitudesPage({ gestion = false }: { gestion?: boolean }) {
  ...
  const gestionRef = useRef<HTMLFormElement>(null);
  ...
  async function guardarGestion() {
    ...
    try {
      const valores = new FormData(gestionRef.current || undefined);
      const payload = {
        estado: String(valores.get("estado") || gestionForm.estado),
        prioridad: String(valores.get("prioridad") || gestionForm.prioridad),
        responsable: String(valores.get("responsable") || ""),
      };
      ...
      setSuccess("Gestión actualizada.");
    }
