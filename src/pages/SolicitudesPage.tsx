...
export function SolicitudesPage({ gestion = false }: { gestion?: boolean }) {
  ...
  async function guardarGestion(event: FormEvent) {
    event.preventDefault();
    if (!seleccionada) return; setGuardando("gestion"); setError("");
    try {
      const data = await actualizarGestionSolicitud(seleccionada.id, gestionForm);
